      ...
      <div className="footer-content">
        ...
        <nav className="footer-nav-grid">
          ...
          <div className="footer-nav-column">
            ...
            <button onClick={() => onNavigate('About Us')} className="nav-link">
              <span className="link-icon">▸</span>About
            </button>
            <button onClick={() => onNavigate('Our Innovation')} className="nav-link">
          ...
          <div className="footer-nav-column">
            ...
            <button onClick={() => onNavigate('How It Works')} className="nav-link">
              <span className="link-icon">▸</span>How It Works
            </button>
            <button onClick={() => onNavigate('FAQ')} className="nav-link">
              <span className="link-icon">▸</span>FAQ
            </button>
            <button onClick={() => onNavigate('Success Stories')} className="nav-link">
              <span className="link-icon">▸</span>Success
            </button>
            <button onClick={() => onNavigate('Platform Stats')} className="nav-link">
              <span className="link-icon">▸</span>Platform Stats
            </button>
            <button onClick={() => onNavigate('System Health')} className="nav-link">
          ...
          <div className="footer-nav-column">
            ...
            <button onClick={() => onNavigate('Leaderboard')} className="nav-link">
              <span className="link-icon">▸</span>Leaderboard
            </button>
            <button onClick={() => onNavigate('Rewards')} className="nav-link">
          ...
          <div className="footer-nav-column">
            ...
            <button onClick={() => onNavigate('Idea Hub')} className="nav-link">
              <span className="link-icon">▸</span>Idea Hub
            </button>
            <button onClick={() => onNavigate('Report Bug')} className="nav-link">
        ...
        <div className="footer-legal">
          <button onClick={() => onNavigate('Privacy')} className="footer-legal-btn">Privacy</button>
          <span className="legal-dot">•</span>
          <button onClick={() => onNavigate('Terms')} className="footer-legal-btn">Terms</button>
          <span className="legal-dot">•</span>
